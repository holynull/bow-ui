...
export class BootService {
    ...
    private initContracts() {
        this.chainConfig.contracts.coins.forEach((e) => {
            this.contracts.push(new this.web3.eth.Contract(HRC20.abi, e.address));
        });
        // @ts-ignore
        this.poolContract = new this.web3.eth.Contract(BowPool.abi, this.chainConfig.contracts.Pool.address);
